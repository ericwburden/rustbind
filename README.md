...
[![R build status](https://github.com/extendr/rustbind/workflows/R-CMD-check/badge.svg)](https://github.com/extendr/rustbind/actions)
...
```r
remotes::install_github("extendr/rustbind")
```
